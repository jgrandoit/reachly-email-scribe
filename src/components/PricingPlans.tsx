...
export const pricingPlans = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Zap, text: "ChatGPT 4o AI model", note: "Faster, smarter replies than Free plan" },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Zap, text: "ChatGPT 4 AI model", note: "Advanced reasoning & personalization", highlight: true },
    ],
    highlight: true,
    mostPopular: true,
  },
